...
const PoliticaPrivacidade = () => {
  return (
    <Container className="">
      ...
      <p>
        No Sublinks.me, respeitamos sua privacidade e estamos comprometidos em
      ...
      <p>
        ...
        cria uma conta, adiciona links ou interage com nosso site. Isso pode
        incluir seu nome, e-mail e outras informações pessoais.
      </p>
      <h2>2. Uso das Informações</h2>
      <p>
        Usamos suas informações para fornecer e melhorar nossos serviços,
        personalizar sua experiência no site, e para nos comunicarmos com você.
      </p>
      <h2>3. Compartilhamento de Informações</h2>
      <p>
        Não compartilhamos suas informações pessoais com terceiros, exceto
        quando necessário para fornecer nossos serviços ou conforme exigido por
        lei.
      </p>
      ...
      <p>
        ...
        qualquer momento. Quaisquer alterações serão publicadas nesta página e
