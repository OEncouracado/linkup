  ...
  return (
    <div className="w-100 my-1">
      <InputGroup style={{ margin: "auto", border: "0.1rem solid #DEE2E6", borderRadius: "0.4rem" }}>
        <InputGroup.Text style={{ border: "solid #DEE2E6", borderWidth: "0 0.1rem 0 0", backgroundColor: "transparent" }} className={`w-50 ${isLightMode ? "text-dark" : "text-light"}`}>Tipo de Fundo:</InputGroup.Text>
